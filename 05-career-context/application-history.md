...
| Date | Item | Status |
|---|---|---|
| **2 Aug 2026** | **ADNEC Group — Head of Creative Services, Abu Dhabi** | 🔥 **STRONGEST UAE LEAD FOUND. CV and cover note prepared — `group-creative-leadership`, full text at `08-uae-income/cv-adnec-head-of-creative.md`. NOT SENT**, gated on one check: does WeDo work for or pitch to ADNEC or any of its seven clusters? If yes, hard no. Also needs the direct-reports number filled or the bracket deleted. Apply via careers.adnecgroup.ae, never LinkedIn. **Do not name a current salary** — anchor AED 35,000+ |
...
| 26 Jul 2026 | **Moss** | Senior/Lead Brand Designer | 🇩🇪 **Berlin** (not Amsterdam) | A1 | `ai-led-brand` | **Prepared, not yet sent** | **Apply to Berlin** — €50,700 floor, not Amsterdam's €71,304. Figma and motion named honestly. Risk is portfolio review |
| 26 Jul 2026 | **egg** | HEAD OF CREATIVE — Event Agency | 🇧🇪 Brussels | A1 | `head-of-creative-events` | **Prepared, not yet sent** | **Best overall alignment found.** Salary expectation **€80,000** against a published €70–85k band; clears all three Brussels thresholds. Apply at careers.egg-events.com |
