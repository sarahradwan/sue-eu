...
|---|---|---|---|---|---|---|---|
| **3 Aug 2026** | ⭐ **gestalten** (Die Gestalten Verlag) | **Editorial Designer** | 🇩🇪 Berlin-Kreuzberg | A1 | *(applied independently — **variant not recorded, ask Sara**)* | ⚪ **Auto-acknowledgement received 3 Aug**, in German: *"wir benötigen noch etwas Zeit… da wir jede Bewerbung sorgfältig prüfen"* | **The best-matched role screened in the whole search.** Email application to `work@gestalten.com`, so a human reads it — no ATS. **Figma and motion are not in the spec**; German not stated in the requirements. ⚠️ **The auto-reply is in German and uses the informal *du*** — weak evidence the internal working language may be German rather than English, though gestalten publishes in English and Berlin employers routinely run German HR templates over English-speaking teams. **Not a conclusion, but ask if they make contact.** ⚠️ **Record what she actually sent** — CV variant, and the desired salary and start date they asked for. **Chase ~17 Aug** (14 days); *"we need more time"* is the same shape as the Karsten auto-ack that then went silent for a month |
