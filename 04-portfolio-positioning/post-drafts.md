...
Finished drafts live here, not in a chat. Her content system notes that two finalised posts
exist only in the original LinkedIn chat, which is a single point of failure. Anything
drafted from now on lands here.

Written under `.claude/skills/linkedin-writer/SKILL.md`. Every draft carries its checklist
result, so she can tell the difference between a draft that was safe and one that was
quietly edited to be.
...
- **Aug 10, Tour & Taxis:** her draft, with two required factual corrections and one
  verified addition, in `dual-audience-content-engine.md`
- **Jul 30, Cairo Doha Dubai:** finalised, still only in the original LinkedIn chat. Worth
  pasting here so it is not lost
